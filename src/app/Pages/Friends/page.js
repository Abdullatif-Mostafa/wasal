...
const FriendsPage = () => {
  ...
  const text = "تعذر تحميل الاصدقاء"
  return (
    <div className="bg-gradient-to-br from-cyan-50 via-white to-teal-100 py-10 font-[Ruboto,sans-serif]">
      <div style={{ display: "flex", justifyContent: "space-between" }} className="max-w-3xl  mx-auto bg-white/90 rounded-3xl shadow-2xl p-8 border border-cyan-100 backdrop-blur-md flex flex-col gap-8">
